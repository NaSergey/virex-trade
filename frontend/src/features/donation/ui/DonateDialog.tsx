...
/**
 * Шаг примерно вдвое, а не «10-20-40-50-100»: соседние кнопки должны отличаться
 * заметно, иначе выбор между 40 и 50 превращается в задачу, которой у человека
 * не было. Четыре деления держат ряд в одну строку даже на телефоне.
 */
