...
import type { EquityPoint, RangeTf, Trade } from '@/entities/trade';

// «Выборка»: произвольная комбинация фильтров по сделкам → сводка против
...
export type { RangeTf } from '@/entities/trade';
