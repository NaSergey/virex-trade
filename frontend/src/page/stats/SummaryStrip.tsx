...
import type { TradeStats } from '@/shared/api/bybit/hooks';
    ...
    <div className="metrics" aria-hidden>
      {Array.from({ length: 9 }, (_, i) => (
        <div className="mcell" key={i}>
          <span className="skel" style={{ height: 8, width: '70%', margin: 0 }} />
          <span className="skel" style={{ height: 18, width: '85%', margin: 0 }} />
          <span />
        </div>
      ))}
    </div>
